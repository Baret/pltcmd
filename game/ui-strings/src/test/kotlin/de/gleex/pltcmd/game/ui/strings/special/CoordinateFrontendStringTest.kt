        ...
        FrontendString.ObjectFormatter.values()
                .forEach { length ->
                    "be formatted correctly for length $length" {
                        ...
                        when (length) {
                            FrontendString.ObjectFormatter.ICON    -> actual shouldBe "|"
                            FrontendString.ObjectFormatter.SHORT3  -> actual shouldBe "1|4"
                            FrontendString.ObjectFormatter.SHORT5  -> actual shouldBe "(1|4)"
                            FrontendString.ObjectFormatter.SIDEBAR -> actual shouldBe "(123|456)"
                            FrontendString.ObjectFormatter.FULL    -> actual shouldBe "(123|456)"
                        }
                    }
                }
    }
        ...
        FrontendString.ObjectFormatter.values()
                .forEach { length ->
                    "use a star for easting when necessary for length $length (like $longEasting)" {
                        ...
                        when (length) {
                            FrontendString.ObjectFormatter.ICON    -> actual shouldBe "|"
                            FrontendString.ObjectFormatter.SHORT3  -> actual shouldBe "*|5"
                            FrontendString.ObjectFormatter.SHORT5  -> actual shouldBe "(*|5)"
                            FrontendString.ObjectFormatter.SIDEBAR -> actual shouldBe "(1234|567)"
                            FrontendString.ObjectFormatter.FULL    -> actual shouldBe "(1234|567)"
                        }
                    }
                }
        ...
        FrontendString.ObjectFormatter.values()
                .forEach { length ->
                    "use a star for northing when necessary for length $length (like $longNorthing)" {
                        ...
                        when (length) {
                            FrontendString.ObjectFormatter.ICON    -> actual shouldBe "|"
                            FrontendString.ObjectFormatter.SHORT3  -> actual shouldBe "1|*"
                            FrontendString.ObjectFormatter.SHORT5  -> actual shouldBe "(1|*)"
                            FrontendString.ObjectFormatter.SIDEBAR -> actual shouldBe "(123|4567)"
                            FrontendString.ObjectFormatter.FULL    -> actual shouldBe "(123|4567)"
                        }
                    }
                }
        ...
        FrontendString.ObjectFormatter.values()
                .forEach { length ->
                    "use two stars when necessary for length $length (like $longCoordinate)" {
                        ...
                        when (length) {
                            FrontendString.ObjectFormatter.ICON    -> actual shouldBe "|"
                            FrontendString.ObjectFormatter.SHORT3  -> actual shouldBe "*|*"
                            FrontendString.ObjectFormatter.SHORT5  -> actual shouldBe "(*|*)"
                            FrontendString.ObjectFormatter.SIDEBAR -> actual shouldBe "(12345|67890)"
                            FrontendString.ObjectFormatter.FULL    -> actual shouldBe "(12345|67890)"
                        }
                    }
                }
    }
                ...
                .forEach { length ->
                    "should use two minus when necessary for length $length (like $negative)" {
                        ...
                        when (length) {
                            ...
                            FrontendString.ObjectFormatter.SHORT3  -> actual shouldBe "-|-"
                            FrontendString.ObjectFormatter.SHORT5  -> actual shouldBe "(-|-)"
                            FrontendString.ObjectFormatter.SIDEBAR -> actual shouldBe "(-123|-345)"
                            FrontendString.ObjectFormatter.FULL    -> actual shouldBe "(-123|-345)"
                        }
                    }
                }
                ...
                .forEach { length ->
                    "should use a minus AND a star when necessary for length $length (like $negativeAndLong)" {
                        ...
                        when (length) {
                            ...
                            FrontendString.ObjectFormatter.SHORT3  -> actual shouldBe "-|*"
                            FrontendString.ObjectFormatter.SHORT5  -> actual shouldBe "(-|*)"
                            FrontendString.ObjectFormatter.SIDEBAR -> actual shouldBe "(-123|45678)"
                            FrontendString.ObjectFormatter.FULL    -> actual shouldBe "(-123|45678)"
                        }
                    }
                }
    }
