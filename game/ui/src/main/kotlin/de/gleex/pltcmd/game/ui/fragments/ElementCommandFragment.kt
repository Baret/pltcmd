 ...
 */
class ElementCommandFragment(override val width: Int, private val world: GameWorld, val hq: ElementEntity, elements: List<ElementEntity>, private val mapOffset: Position) : BaseFragment, (MouseEvent, UIEventPhase) -> UIEventResponse {
    ...
    private fun sendMoveTo() {
        ...
        hq.startConversation(conversation)
    }
