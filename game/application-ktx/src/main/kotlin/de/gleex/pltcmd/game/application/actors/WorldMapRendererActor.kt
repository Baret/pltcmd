...
class WorldMapRendererActor(private val worldMap: WorldMap) : Actor() {
    ...
    private val bottomLeftCoordinate = worldMap.origin
    ...
    private inline fun ShapeRenderer.drawWithType(type: ShapeRenderer.ShapeType, crossinline drawInstructions: ShapeRenderer.() -> Unit) {
        begin(type)
        drawInstructions()
        end()
    }
